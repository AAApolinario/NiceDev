 ...
 * http://twitter.github.com/bootstrap/javascript.html#transitionsthis.$indicators
 * ===================================================
...
!function ($) {
  ...
  * ========================= */
  ...
  , getActiveIndex: function () {
      ...
      console.log(this.$items.index(this.$active));
      var item_index = this.$items.index(this.$active);
      if (item_index < 8)
          return 0;
