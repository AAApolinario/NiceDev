...
$(document).ready(function () {
    ...
    if($('#data-table')[0]) {
        ...
        var dataTableButtons =  '<div class="dataTables_buttons hidden-sm-down actions">' +
                                    '<span class="actions__item zmdi zmdi-download" data-table-action="excel" />' +
                                    ...
                                    '<div class="dropdown actions__item">' +
                                        ...
                                        '<ul class="dropdown-menu dropdown-menu-right">' +
                                            '<a href="" class="dropdown-item" data-table-action="excel">Excel 2(.xlsx)</a>' +
                                            '<a href="" class="dropdown-item" data-table-action="csv">CSV 2(.csv)</a>' +
                                        '</ul>' +
                                    '</div>' +
                                '</div>';
